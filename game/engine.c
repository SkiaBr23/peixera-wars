/*! \file engine.c
	\brief Módulo de implementação do módulo engine.h */
...
/****************************************************************************/
/**
* \fn CriaEstruturas(CabecaGeral* Interface,int novawave,int valor)
*
* \brief Realiza a alocação das estruturas Castelo e CabecaPFilas e inicializa com valor NULL todas as estruturas internas de cada uma das
* estruturas alocadas anteriormente.
*
* @param Interface - ponteiro para a controladora (CabecaGeral*) do game.
* @param novawave - determina o valor inicial.
* @param valor - informa a quantidade de ouro
* 
* \return Retorna a cabeça da estrutura com todas as estruturas Castelo e CabecaPFilas alocadas com seus ponteiros internos apontando para NULL.
* 
...
ASSERTIVAS DE ENTRADA: A estrutura controladora precisa ter sido alocada, um valor de inteiro "novawave" que assume valores de 1 ou 0 onde verifica se o jogo é novo ou carregado e um valor int do ouro carregado.
...
void CriaEstruturas(CabecaGeral* Interface,int novawave,int valor){
	if(Interface!=NULL){
		...
		Interface->castle = CriaCastelo(novawave,valor);
...
/****************************************************************************/
/**
* \fn void InicializaEstruturas(CabecaGeral* Interface,int status,int cuQ,int nQ,int cuCDT,int nCDT,int cuCDL,int nCDL,int tC,int nC)
* 
* \brief Aloca as estruturas internas de Castelo e CabecaPFilas.
*
* @param Interface - ponteiro para a controladora do game (CabecaGeral*)
* @param status - valor inteiro que indica se as estruturas serão alocadas com os valores iniciais do game ou a partir de um valor específico
* @param cuQ - valor inteiro que representa o custo para a criação de um personagem do edifício Quartel
* @param nQ - valor inteiro que representa o nível do edifício quartel
* @param cuCDT - valor inteiro que representa o custo para a criação de um personagem do edifício Campo de Tiro
* @param nCDT - valor inteiro que representa o nível do edifício Campo de Tiro
* @param cuCDL - valor inteiro que representa o custo para a criação de um personagem do edifício Cada das Lanças
* @param nCDL - valor inteiro que representa o nível do edifício Casa das Lanças
* @param tC - valor inteiro que representa a quantidade de recursos gerados pelo edifício Comercio
* @param nC - valor inteiro que representa o nível do edifício Comercio
* 
...
ASSERTIVAS DE SAÍDA: Não há.
INTERFACE EXPLÍCITA: O tipo de retorno void e os  de entrada.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
...
/****************************************************************************/
/**
* \fn VerificaInterface(CabecaGeral* Interface)
* 
* \brief Verifica se a estrutura controladora está alocada ou não.
*
* @param Interface - ponteiro para a controladora (CabecaGeral*) do game.
* 
* \return Retorna o valor inteiro 1 caso a estrutura esteja alocada, caso contrário retorna 0.
* 
* Assertiva de entrada
*
...
* \fn Inicia()
*
* \brief Executa a exibição do menu principal para o jogador iniciar, carregar, visualizar os créditos ou sair do jogo.
*
* \return void - não possui retorno.
* 
* Assertiva de entrada
...
/****************************************************************************/
/**
* \fn StartGame(CabecaGeral* Cabeca, int horda)
* 
* \brief Realiza a chamada para o começo do jogo, verificando se o jogo está sendo iniciado do começo ou a partir de algum save.
*
* @param Cabeca - ponteiro para a controladora (CabecaGeral*) do game.
* @param horda - valor inteiro que representa a horda de inimigos da cpu, caso seja utilizada a função de Load Game.
* 
* \return void - não possui retorno.
* 
* Assertiva de entrada
...
INTERFACE EXPLÍCITA: O tipo de retorno void e os  de entrada CabecaGeral* Cabeca, int horda.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
void StartGame(CabecaGeral* Cabeca, int horda){
	...
	if(Cabeca == NULL){
		CriaEstruturas(Interface,1,100);
...
/****************************************************************************/
/**
* \fn SaveGame(CabecaGeral* Interface, int horda)
*
* \brief Realiza a gravação dos  do game em um arquivo  binário para posterior leitura e continuação do jogo.
*
* @param Interface - ponteiro para a controladora (CabecaGeral*) do game.
* @param horda - valor inteiro que representa a horda atual de inimigos do jogo.
* 
* \return void - não possui retorno.
* 
* Assertiva de entrada
...
ASSERTIVAS DE SAÍDA: Não há.
INTERFACE EXPLÍCITA: O tipo de retorno void, os  de entrada CabecaGeral* Cabeca, int horda e mensagem exibida ao usuário.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
...
* \fn void LoadGame()
* 
* \brief Realiza a leitura do arquivo binário gerado pela função Save Game e continua com o jogo.
*
* Não possui .
* 
* \return void - não possui retorno.
...
void LoadGame(){
	...
	CriaEstruturas(Interface,0,ouro);
...
/****************************************************************************/
/**
* \fn int MenuEvolucaoEdificio(CabecaGeral* Interface)
* 
* \brief Realiza a evolução de um dos edifícios do jogo.
*
* @param Interface - ponteiro para a controladora (CabecaGeral*) do game.
* 
* \return EvoluiuEdificio - valor inteiro que indica se foi realizada a evolução de um dos edifícios.
* 
* Assertiva de entrada
*
* A estrutura controladora enviada para a função precisa ter sido declarada e alocada.
...
/****************************************************************************/
/**
* \fn MenuEscolhaUnidade(CabecaGeral* Interface)
* 
* \brief Realiza a escolha do personagem a ser criado no jogo.
*
* @param Interface - ponteiro para a controladora (CabecaGeral*) do game.
* 
* \return Retorna o valor inteiro 1 caso um dos personagens tenha sido criado, ou 0 caso nenhum tenha sido criado.
* 
* Assertiva de entrada
*
* A estrutura controladora enviada para a função precisa ter sido declarada e alocada.
		...
		case 2:
			if(Interface->castle->campodetiro->nivel == 1){
				if(Interface->castle->ouro >= Interface->castle->campodetiro->custounidade){
					Interface->character->player = InserirUnidadeFinal(Interface->character->player,280,60,0.2,1,2);				
			...
			if(Interface->castle->campodetiro->nivel == 2){
				if(Interface->castle->ouro >= Interface->castle->campodetiro->custounidade){
					Interface->character->player = InserirUnidadeFinal(Interface->character->player,280,60,0.3,2,2);				
					Interface->castle = AtualizarCasteloOuro(Interface->castle,(-Interface->castle->campodetiro->custounidade));
					mvprintw(2, 80, "            ");
					mvprintw(2, 80, "Gold$ %d", Interface->castle->ouro);
					refresh();
			...
			if(Interface->castle->campodetiro->nivel == 3){
				if(Interface->castle->ouro >= Interface->castle->campodetiro->custounidade){
					Interface->character->player = InserirUnidadeFinal(Interface->character->player,280,60,0.4,3,2);				
					Interface->castle = AtualizarCasteloOuro(Interface->castle,(-Interface->castle->campodetiro->custounidade));
					mvprintw(2, 80, "            ");
					mvprintw(2, 80, "Gold$ %d", Interface->castle->ouro);
					refresh();
		...
		case 3:
			if(Interface->castle->casadaslancas->nivel == 1){
				if(Interface->castle->ouro >= Interface->castle->casadaslancas->custounidade){
					Interface->character->player = InserirUnidadeFinal(Interface->character->player,280,70,0.15,1,3);				
			...
			if(Interface->castle->casadaslancas->nivel == 2){
				if(Interface->castle->ouro >= Interface->castle->casadaslancas->custounidade){
					Interface->character->player = InserirUnidadeFinal(Interface->character->player,280,90,0.15,2,3);				
					Interface->castle = AtualizarCasteloOuro(Interface->castle,(-Interface->castle->casadaslancas->custounidade));
					mvprintw(2, 80, "            ");
					mvprintw(2, 80, "Gold$ %d", Interface->castle->ouro);
					refresh();
			...
			if(Interface->castle->casadaslancas->nivel == 3){
				if(Interface->castle->ouro >= Interface->castle->casadaslancas->custounidade){
					Interface->character->player = InserirUnidadeFinal(Interface->character->player,280,120,0.15,3,3);				
					Interface->castle = AtualizarCasteloOuro(Interface->castle,(-Interface->castle->casadaslancas->custounidade));
					mvprintw(2, 80, "            ");
					mvprintw(2, 80, "Gold$ %d", Interface->castle->ouro);
					refresh();
...
/****************************************************************************/
/**
* \fn void Run (CabecaGeral* Interface, int new, int wave)
* 
* \brief Realiza a execução do loop principal do game, avançando as hordas de inimigos e executando as funções de criação e evolução de edifícios * e personagens.
*
* @param Interface - ponteiro para a controladora (CabecaGeral*) do game.
* @param new - valor inteiro que indica se o jogo está sendo iniciado do começo ou a partir de um save.
* @param wave - valor inteiro que representa a horda de inimigos caso seja executado o jogo a partir de um load.
* 
* \return void - não possui retorno.
* 
* Assertiva de entrada
...
ASSERTIVAS DE SAÍDA: Não há.
INTERFACE EXPLÍCITA: O tipo de retorno void e os  de entrada CabecaGeral* Interface, int new, int wave.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
void Run (CabecaGeral* Interface, int new, int wave){
	...
	WINDOW *winhud = newwin(HUDH,COLS, 0, 0);
	WINDOW *wincastle = newwin(LINES-HUDH, CASTLEW, HUDH,0);
	WINDOW *winfield = newwin(LINES-HUDH, COLS-CASTLEW, HUDH, CASTLEW);
	...
	if(!CabecaGeralVazia(Interface)){
		...
		print_hud(winhud,Interface->castle->ouro,horda);
		wrefresh(winhud);
			...
			if(newhorda==1){	/*momento de pausa para o jogador fazer as evoluções e compras de unidades*/
				...
				for (i = 0; i < 4; i++)
				{
					if(horda == 10)
					{
						...
						InsereUnidadeInimiga(Interface,horda);
...
/****************************************************************************/
/**
* \fn int GameLoop (CabecaGeral * Interface, WINDOW * winfield)
* 
* \brief Realiza o loop de batalhas entre o player e o cpu no game.
*
*
* @param Interface - ponteiro para a controladora do game (CabecaGeral*)
* @param winfield - ponteiro para a estrutura WINDOW (estrutura da biblioteca ncurses) para realizar a visualização dos combates.
* 
* \return Retorna o valor inteiro 0 caso o player tenha vencido a batalha ou 1 caso o cpu tenha vencido a batalha.
* 
* Assertiva de entrada
*
...
INTERFACE EXPLÍCITA: Tipo de retorno int e os  de entrada CabecaGeral * Interface, WINDOW * winfield.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
...
/****************************************************************************/
/**
* \fn int Batalha(CabecaGeral *Interface, WINDOW *winfield)
* 
* \brief Realiza a seleção do inimigo a ser atacado pelo player, um ataque para cada um de seus personagens.
*
* @param Interface - ponteiro para a controladora do game (CabecaGeral*)
* @param winfield - ponteiro para a estrutura WINDOW (estrutura da biblioteca ncurses) para realizar a visualização do game.
* 
* \return Retorna o valor inteiro 1 caso o player tenha vencido a batalha ou 0 caso todos os ataques tenham sido realizados e ainda existem
* inimigos na cpu.
* 
* Assertiva de entrada
*
...
INTERFACE EXPLÍCITA: O tipo de retorno int e os  de entrada CabecaGeral *Interface, WINDOW *winfield.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
...
/****************************************************************************/
/**
* \fn Unidade *Atacar(Unidade *atacante, Unidade *vitima)
* 
* \brief Realiza o ataque de um personagem do player sobre um dos personagens do cpu.
*
* @param atacante - ponteiro para o personagem do player (Unidade*) que vai realizar o ataque
* @param vitima - ponteiro para o personagem do cpu (Unidade*) que vai receber o ataque
* 
* \return Retorna a lista de personagen da cpu atualizada.
* 
* Assertiva de entrada
*
...
ASSERTIVAS DE SAÍDA: Não há.
INTERFACE EXPLÍCITA: O tipo de retorno Unidade* e os  de entrada Unidade *atacante, Unidade *vitima. As mensagens para o usuário.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
...
/****************************************************************************/
/**
* \fn int Batalha2(CabecaGeral *Interface, WINDOW *winfield)
*
* \brief Função que executa o loop de ataque da cpu contra os personagens do player.
*
* @param Interface - ponteiro para a controladora (CabecaGeral*) do game.
* @param winfield - ponteiro para WINDOW (parâmetro da biblioteca ncurses) para atualizar a janela de exibição do game.
* 
* \return Retorna o valor inteiro 0 caso todos os ataques tenham sido feitos e ainda existam personagens do player, ou 2 caso todos os personagens * do player tenham sido eliminados.
* 
* Assertiva de entrada
*
* A estrutura controladora enviada para a função precisa ter sido declarada e alocada.
...
INTERFACE EXPLÍCITA: Tipo de retorno int e  de entrada CabecaGeral *Interface, WINDOW *winfield. As mensagens de erro impressas a cada situação.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
...
/****************************************************************************/
/**
* \fn Unidade * buscaAlvo (Unidade * vitima)
* 
* \brief Realiza a busca pelo personagem mais fraco do player para que a cpu possa realizar o ataque.
*
* @param vitima - ponteiro para a lista de personagens do player (Unidade*).
*
* \return Retorna o ponteiro para o personagem (Unidade*) a ser atacado.
* 
* Assertiva de entrada
*
...
/****************************************************************************/
/**
* \fn Unidade *AtaqueInimigo(int * hit, Unidade *atacante, Unidade *vitima)
*
* \brief Realiza o ataque de um personagem do cpu sobre um personagem do player.
*
* @param hit - ponteiro para um valor inteiro que vai indicar se foi realizado o ataque com eficiencia ou não
* @param atacante - ponteiro para o personagem da cpu (Unidade*) que vai realizar o ataque
* @param vitima - ponteiro para o personagem do player (Unidade*) que vai ser atacado
* 
* \return Retorna a lista de personagens do player atualizada após o ataque.
* 
* Assertiva de entrada
*
...
INTERFACE EXPLÍCITA: O tipo do retorno Unidade* e os  de entrada int * hit, Unidade *atacante, Unidade *vitima.
...
/****************************************************************************/
/**
* \fn TemQuatro(Unidade* lista)
*
* \brief Função para verificar se já existem 4 personagens na lista do player, para que ele possa escolher seus personagens.
*
* @param lista - ponteiro para a lista de personagens (Unidade*)
*
* \return Retorna o valor inteiro 1 caso já existam 4 personagens, ou 0 caso caso existam menos de 4.
* 
* Assertiva de entrada
*
* A lista de personagens do player precisa ter sido declarada e alocada.
...
/****************************************************************************/
/**
* \fn int GerarValor(int a, int b)
*
* \brief Função que gera um valor aleatório entre 1 e 3 que vai indicar o tipo de personagem a ser criado pelo cpu.
*
* @param a - valor inteiro que indica o valor máximo entre os dois.
* @param b - valor inteiro que indica o valor mínimo entre os dois.
*
* \return Retorna o valor inteiro, entre gerado pelo função rand.
* 
* Assertiva de entrada
*
...
ASSERTIVAS DE SAÍDA: Não há.
INTERFACE EXPLÍCITA: O tipo de retorno int e os  de entrada int a, int b.
...
/****************************************************************************/
/**
* \fn void InsereUnidadeInimiga(CabecaGeral* Interface, int horda)
* 
* \brief Realiza a inserção de um personagem na lista de personagens do cpu, de acordo com os valores gerados para a classe e nível.
*
* @param Interface - ponteiro para a controladora do game (CabecaGeral*)
* @param horda - valor inteiro que indica a horda de inimigos no jogo.
* 
* \return Retorna o valor inteiro 0 caso o player tenha vencido a batalha ou 1 caso o cpu tenha vencido a batalha.
* 
* Assertiva de entrada
...
INTERFACE EXPLÍCITA: O tipo de retorno void e os  de entrada CabecaGeral* Interface, int horda.
INTERFACE IMPLÍCITA: As estruturas e variáveis auxiliares, as assertivas de entrada e saída e as operações realizadas com os valores enviados como parâmetro.
*/
...
/****************************************************************************/
/**
* \fn InsereUnidadeBoss(CabecaGeral* Interface)
*
* \brief Realiza a inserção do personagem Boss na lista de personagens do cpu quando o player vencer as 10 hordas de inimigos.
*
* @param Interface - ponteiro para a controladora do game (CabecaGeral*)
*
* \return void - não possui retorno.
...
/****************************************************************************/
/**
* \fn int GerarNivel(int horda)
*
* \brief Função que verifica o nível do personagem a ser criado pela cpu, de acordo com a horda de inimigos do game.
*
* @param horda - valor inteiro que representa a horda de inimigos do jogo.
*
* \return Retorna um valor inteiro entre 1 e 3, indicando o nível do personagem a ser criado.
* 
* Assertiva de entrada
*
