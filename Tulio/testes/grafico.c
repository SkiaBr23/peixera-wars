...
void creditos(int y, int x)
{
	...
	mvwprintw(creditos, 2, 4, "Maximillian Fan Xavier");
	mvwprintw(creditos, 3, 4, "Otavio Alves Dias");
	mvwprintw(creditos, 4, 4, "Rafael Dias da Costa");
	mvwprintw(creditos, 5, 4, "Tulio Abner de Lima");
