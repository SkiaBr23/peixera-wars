...
O projeto tem como objetivo principal a construção de um Game de estratégia executado por turnos, onde o jogador tem a possibilidade de criar personagens (Soldado, Lanceiro e Arqueiro) para derrotar as 10 hordas de inimigos e então enfentar o personagem Boss para conseguir a vitória.
...
2 - Ao final da execução (executando todas as operações de evolução, criação e função de load) será necessário que o usuário rode o comando:
